    ...
    <Root>
      <AppBar position="static" sx={{ background: "#006064" }}>
        <Toolbar>
          ...
          <Link to="/con1" style={{ color: '#fff', textDecoration: 'none' }}><Typography
            variant="h6"
            sx={{ flexGrow: 0, paddingLeft: "50px", textAlign: 'left', fontFamily: "Helvetica Neue", cursor: 'pointer' }}
          ...
          >
            <MenuItem onClick={() => handleMenuClose(setAnchorElCities)}>Coimbatore</MenuItem>
            <MenuItem onClick={() => handleMenuClose(setAnchorElCities)}>Chennai</MenuItem>
            <MenuItem onClick={() => handleMenuClose(setAnchorElCities)}>Bangalore</MenuItem>
          </Menu>
      ...
      <main>
              ...
              <Grid item xs={6} md={4}>
                <Card sx={{}}>
                  ...
                  <CardContent>
                    ...
                    <Typography>
                    Let the waterfall of life wash over you, cleansing your soul with its pure energy.
                    </Typography>
                    <Box sx={{ textAlign: 'center', mt: 2 }}>
                      <Button endIcon={<ArrowForwardIcon />}>
                      </Button>
              ...
              <Grid item xs={6} md={4}>
                <Card sx={{}}>
                  <CardMedia
                    component="img"
                    height="300"
                    image="https://i.pinimg.com/474x/57/32/1b/57321b3fca7242ba52da622d3b079b35.jpg"
                    alt="Desserts"
                  />
                  <CardContent>
                    <Typography gutterBottom variant="h5" component="h2">
        ...
        <Section sx={{}}>
        <Typography component="h6"><b>GET A GLIMPSE OF COZYCORNER </b></Typography>
          <Container maxWidth="l">
            <Typography variant="h4" align="center" color="textPrimary" gutterBottom>
            </Typography>
            <Grid container spacing={4}>
              <Grid item xs={6} md={4}>
                <Card sx={{}}>
                  <CardMedia
                    component="img"
                    height="300"
                    image="https://dlifeinteriors.com/wp-content/uploads/2020/10/decorative-wall-unit-home-kochi.jpg"
                    alt="Appetizers"
                  />
                </Card>
              </Grid>
                ...
                <Card sx={{}}>
                  <Link to="/water">
                    <CardMedia
                      component="img"
                      height="300"
                      image="https://i.pinimg.com/474x/63/dd/f3/63ddf30e35e44caf523c9aebe22db27f.jpg"
                      alt="Main Courses"
                    />
                  </Link>
                </Card>
              ...
              <Grid item xs={6} md={4}>
                <Card sx={{}}>
                  <CardMedia
                    component="img"
                    height="300"
                    image="https://i.pinimg.com/474x/24/42/af/2442af788b8f7246ab5ab22ae1c1629d.jpg"
                    alt="Desserts"
                  />
                </Card>
              </Grid>
